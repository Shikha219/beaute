...
def plotColorBar(colorInformation):
    ...
    # top_x + (colorInformation[1]["color_percentage"] * color_bar.shape[1])
    bottom_x = 1000
    # print('-----')
    # print(bottom_x)
    # print('------')
    ...
    for colour in colorInformation[0]['color']:
        if int(colour) > 40:
            ...
            cv2.rectangle(color_bar, (int(top_x), -1),
                          (int(bottom_x), color_bar.shape[0]), color, -10)
        #top_x = bottom_x
    return color_bar
...
def predict():
    ...
    # image = imutils.url_to_image('https://static.boredpanda.com/blog/wp-content/uploads/2020/08/black-women-fantasy-photos-18-5f3109ccaad60__700.jpg')
    ...
    # print(Y_train)
    X_test = np.array([[dominantColors[0]['color'][0], dominantColors[0]
                        ['color'][1], dominantColors[0]['color'][2]]])
    ...
    return listToString(predicted_tone)
